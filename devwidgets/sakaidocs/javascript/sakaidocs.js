    ...
    sakai_global.sakaidocs = function (tuid, showSettings) {
        ...
        var init_tinyMCE = function(){
            if (window["tinyMCE"]) {
                ...
                var language = "pt"; // Campus lang en -> pt
                ...
                tinyMCE.init({
                    ...
                    // Context Menu - // Campus link button
                    theme_advanced_buttons1: "formatselect,fontselect,fontsizeselect,bold,italic,underline,|,forecolor,backcolor,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,",
                    theme_advanced_buttons2: "table,link,|,code,|,help,",
