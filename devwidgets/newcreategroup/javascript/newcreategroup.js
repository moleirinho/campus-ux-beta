...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    sakai_global.newcreategroup = function(tuid, showSettings, widgetData){
        ...
        /* Campus add course only jose & marlene 
        if (widgetData.category === 'course') {
            if (sakai.data.me.user.username != 'jose' || sakai.data.me.user.username != 'marlene'){
                window.location = "/parcerias";
            }
        }*/
